import {
	...
	GraphQLString,
	GraphQLObjectType,
	GraphQLObjectTypeConfig, GraphQLInterfaceType, GraphQLInterfaceTypeConfig, GraphQLList, GraphQLFieldConfigMap,
...
const NodeType = new GraphQLInterfaceType(<GraphQLInterfaceTypeConfig<Element,
		any>>{
	name: 'Node',
...
const DocumentType = new GraphQLObjectType(<GraphQLObjectTypeConfig<Element,
		any>>{
	name: 'Document',
...
export const ElementType = new GraphQLObjectType(<GraphQLObjectTypeConfig<Element,
		any>>{
	name: 'Element',
